@echo off
REM ============================================================================
REM build.bat - Windows Build Script for AR Calibration System
REM Author: Krushna Sanjay Sharma
REM Description: Builds the Camera Calibration and Augmented Reality System
REM              with OpenCV
REM Date: March 2026
REM ============================================================================

echo ========================================
echo AR Calibration System Build
...
echo.
echo ========================================
echo Building AR Calibration System...
echo ========================================
echo.
...
echo ========================================
echo Executables (enabled as tasks complete):
echo ========================================
echo   calibrateCamera.exe  - Tasks 1-3: corner detection + calibration
echo   augmentedReality.exe - Tasks 4-6: pose estimation + AR object
echo   featureDetector.exe  - Task  7:   feature detection
echo.
